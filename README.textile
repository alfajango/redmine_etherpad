...
Alternatively, if you just want to configure the etherpad host, you may also do this by setting the environment variable:

<pre><code>default:
ETHERPAD_HOST=https://etherpad.example.com
</code></pre>
